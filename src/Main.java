...
////                        Passenger new_user = new Passenger(username, email, phone, password);
////
////                        // Check for Username
...
//                            Ride offers = My_account.getRide();
...
//                                }
//                                System.out.println(My_account.checkOffer(offers.getOffers().get(i)));
...
//                            for (Ride ride : rides) {
//                                System.out.println("Do you want to make offer for ride that has source " + ride.getSource() + " and destination " + ride.getDestination() + " from user " + ride.getPassenger().getUsername() + " ? yes/no");
//                                ch = sc.nextLine();
